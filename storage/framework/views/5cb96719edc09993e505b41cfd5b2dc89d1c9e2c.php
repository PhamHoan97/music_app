...
<!-- jQuery -->
<!-- lined-icons -->
<link rel="stylesheet" href="<?php echo asset('css/icon-font.css'); ?>" type='text/css' />
<link rel="stylesheet" type="text/css" href="<?php echo asset('css/notification.css'); ?>">
<!-- //lined-icons -->
 <!-- Meters graphs -->
<script src="<?php echo asset('js/jquery-2.1.4.js'); ?>"></script>
    ...
    <section>
      <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="<?php echo url('index'); ?>">Mosai<span>c</span></a></h1>
			</div>
			<div class="logo-icon text-center">
				<a href="<?php echo url('index'); ?>">M </a>
			</div>
 	 <!-- /w3l-agile -->
					...
					<div class="modal-content">
						...
						<div class="col-md-5 app-left mpl">
							...
							<div class="app-devices">
								...
								<a href="#"><img src="<?php echo asset('images/1.png'); ?>" alt=""></a>
								<a href="#"><img src="<?php echo asset('images/2.png'); ?>" alt=""></a>
								<div class="clearfix"> </div>
							</div>
						</div>
						<div class="col-md-7 app-image">
							<img src="<?php echo asset('images/apps.png'); ?>" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
							</div>
					...
					<div class="profile_details">		
						  <div class="col-md-4 serch-part">
							  ...
							  <!-- search-scripts -->
									...
									<script src="<?php echo asset('js/uisearch.js'); ?>"></script>
										<script>
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
										...
										<ul class="rslides callbacks callbacks1" id="slider4">
											   	<li>
														<div class="banner-img">
															 <img src="<?php echo asset('images/11.jpg'); ?>" class="img-responsive" alt="">
														 </div>
												...
												<li>
													<div class="banner-img">
															 <img src="<?php echo asset('images/22.jpg'); ?>" class="img-responsive" alt="">
														 </div>
														<div class="banner-info">
																	  <a class="trend" href="single.html">TRENDING</a>
												...
												<li>
												 <div class="banner-img">
															 <img src="<?php echo asset('images/33.jpg'); ?>" class="img-responsive" alt="">
														 </div>
														<div class="banner-info"> 
														             <a class="trend" href="single.html">TRENDING</a>
																	  <h3>Let Your Home</h3>
				...
				<!--//End-banner-->
					<!--albums-->
					<!-- pop-up-box --> 
							<link href="<?php echo asset('css/popuo-box.css'); ?>" rel="stylesheet" type="text/css" media="all">
							<script src="<?php echo asset('js/jquery.magnific-popup.js'); ?>" type="text/javascript"></script>
							 <script>
					...
					<!--//pop-up-box -->
					<!-- Dùng cơ sở dữ liệu đẩy lên được -->
						<div class="albums">
								...
								<div class="col-md-3 content-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v1.jpg'); ?>" title="allbum-name">
									</a>
								...
								<div class="col-md-3 content-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v2.jpg'); ?>" title="allbum-name">
									</a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div class="col-md-3 content-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v3.jpg'); ?>" title="allbum-name">
									</a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div class="col-md-3 content-grid last-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v4.jpg'); ?>" title="allbum-name">
									</a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div class="col-md-3 content-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v5.jpg'); ?>" title="allbum-name">
									</a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div id="small-dialog" class="mfp-hide">
								...
								<div class="col-md-3 content-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v6.jpg'); ?>" title="allbum-name"></a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div class="col-md-3 content-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v7.jpg'); ?>" title="allbum-name">
									</a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div class="col-md-3 content-grid last-grid">
									<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<img src="<?php echo asset('images/v8.jpg'); ?>" title="allbum-name">
									</a>
									<a class="button play-icon popup-with-zoom-anim" href="#small-dialog">Listen now</a>
								</div>
								<div class="clearfix"> </div>
					...
					<!--//End-albums-->
						...
						<div class="albums second">
										<div class="tittle-head">
											...
											<a href="<?php echo url('index'); ?>"><h4 class="tittle two">See all</h4></a>
											<div class="clearfix"> </div>
										</div>
										<div class="col-md-3 content-grid">
											<a href="<?php echo url('single'); ?>">
												<img src="<?php echo asset('images/v11.jpg'); ?>" title="allbum-name">
											</a>
											<div class="inner-info"><a href="<?php echo url('single'); ?>"><h5>Pop</h5></a></div>
										</div>
										<div class="col-md-3 content-grid">
											<a href="<?php echo url('single'); ?>">
												<img src="<?php echo asset('images/v22.jpg'); ?>" title="allbum-name">
											</a>
											<div class="inner-info">
												<a href="<?php echo url('single'); ?>"><h5>Pop</h5></a></div>
										</div>
										<div class="col-md-3 content-grid">
											<a href="<?php echo url('single'); ?>">
										...
										<div class="col-md-3 content-grid last-grid">
											<a href="<?php echo url('single'); ?>">
												<img src="<?php echo asset('images/v44.jpg'); ?>" title="allbum-name">
											</a>
											<div class="inner-info">
												<a href="<?php echo url('single'); ?>">
													<h5>Pop</h5>
										...
										<div class="col-md-3 content-grid">
											<a href="single.html">
												<img src="<?php echo asset('images/v55.jpg'); ?>" title="allbum-name">
											</a>
											<div class="inner-info">
												<a href="single.html">
													<h5>Pop</h5>
										...
										<div class="col-md-3 content-grid">
											<a href="single.html">
												<img src="<?php echo asset('images/v66.jpg'); ?>" title="allbum-name">
											</a>
											<div class="inner-info">
												<a href="single.html">
													<h5>Pop</h5>
						    ...
						    <!-- 
						    	Video chính  add thêm 1 albums có lượng nghe nhiều nhất 
						    	Thay đổi 1 số thuộc tính thôi và còn đâu js xử lí cho hết
						    -->
										...
										<div id="jp_container_1" class="jp-video jp-video-270p" role="application" aria-label="media player">
											<div class="jp-type-playlist">
												<div id="jquery_jplayer_1" class="jp-jplayer" style="width: 480px; height: 270px;">
													<img id="jp_poster_0" src="<?php echo asset('video/play1.png'); ?>" style="width: 480px; height: 270px; display: inline;">
											...
											<div class="pricing-inner">
												...
												<div class="pricing">
													...
													<div class="price-bottom">
														...
														<a href="<?php echo url('single'); ?>" class="price">Upgrade</a>
													</div>
												</div>
			 	 ...
			 	 <!-- /w3l-agile-its -->
						...
						<div class="review-slider">
								<div class="tittle-head">
								 ...
								 <ul id="flexiselDemo1">
								<li>
									<a href="<?php echo url('single'); ?>"><img src="<?php echo asset('images/v1.jpg'); ?>" alt=""/></a>
									<div class="slide-title"><h4>Adele21 </div>
									<div class="date-city">
										<h5>Jan-02-16</h5>
										<div class="buy-tickets">
											<a href="<?php echo url('single'); ?>">READ MORE</a>
										</div>
									</div>
								</li>
								<li>
								...
								<li>
									<a href="<?php echo url('single.html'); ?>">
										<img src="<?php echo asset('images/v3.jpg'); ?>" alt=""/>
									</a>
								...
								<li>
									<a href="<?php echo url('single'); ?>">
										<img src="<?php echo asset('images/v4.jpg'); ?>" alt=""/>
									</a>
									<div class="slide-title">
								...
								<li>
									<a href="<?php echo url('single'); ?>">
										<img src="<?php echo asset('images/v5.jpg'); ?>" alt=""/>
									</a>
								...
								<li>
									<a href="<?php echo url('single'); ?>">
										<img src="<?php echo asset('images/v6.jpg'); ?>" alt=""/>
									</a>
									<div class="slide-title">
								...
								<li>
									<a href="single.html"><img src="<?php echo asset('images/v6.jpg'); ?>" alt=""/></a>
						...
						<script type="text/javascript" src="<?php echo asset('js/jquery.flexisel.js'); ?>"></script>	
						</div>
								</div>
							<div class="clearfix"></div>
						<!--body wrapper end-->
