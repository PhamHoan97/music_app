		...
		<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="inner-content">
					...
					<!--//pop-up-box -->
					    <!-- Tim kiem ca si , nhac si , bai hat -->
				    ...
				    <div class="browse">
								...
								<div class="col-md-3 browse-grid">
									...
									<a href="{!! url('profile') !!}"><i class="glyphicon glyphicon-play-circle"></i></a>
									<a class="sing" href="{!! url('profile') !!}">Lootera</a>
								</div>
							    ...
							    <div class="col-md-3 browse-grid">
								    ...
								    <a class="sing" href="{!! url('profile') !!}">Jaremy Cam</a>
								</div>
