			...
			<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
			  ...
			  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav mr-auto">
			     ...
			     <li class="nav-item ">
				        <a class="nav-link"  style="color: white;" href="{!! url('notifications') !!}">Notifications <span class="sr-only">(current)</span></a>
				      </li>
				...
				<div class="col-lg-4 form-center">
					<div class="form--cover">
						<div class="form--cover__title text-center">
							<h3>Upload From PC</h3>
							<h5>Via Frontend Uploader</h5>
						</div>
						<div class="form--cover__main">
							<form action="" method="get" accept-charset="utf-8" class="form-uploadFile">
								<label >
									<img src="{!! asset('images/upload.png')!!}" alt="Upload right here" class="img-fluid">
									<input type="file" class="input-file" name="" value="" placeholder=""> 
								</label>
							</form>
						</div>
						<div class="form--cover__title text-center">
					...
					<div class="card" >
					  ...
					  <div class="card-body">
					   ...
					   <div class="card-button">
					     ...
					     <a href="#" class="btn btn-primary button--add"><i class="fas fa-plus-circle" "></i> Add to</a>
